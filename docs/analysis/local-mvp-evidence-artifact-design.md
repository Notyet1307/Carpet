...
retention/cleanup rules. MCR-1067 completed as a read-only GO
...
local fake path. It should not change command behavior, schemas, fixtures,
tests, package files, runtime code, real-service integrations, or GitHub adapter
scope.
